...
from faceswap_colab import curl_builder, logger, process_manager, state_manager, translator
from faceswap_colab.filesystem import get_file_name, get_file_size, is_file, remove_file
from faceswap_colab.hash_helper import validate_hash
from faceswap_colab.types import Command, DownloadProvider, DownloadSet
...
def resolve_download_url_by_provider(download_provider : DownloadProvider, base_name : str, file_name : str) -> Optional[str]:
	download_provider_value = faceswap_colab.choices.download_provider_set.get(download_provider)
