...
from faceswap_colab import state_manager, translator, voice_extractor
from faceswap_colab.filesystem import is_video
from faceswap_colab.types import VoiceExtractorModel
...
def render() -> None:
	...
	VOICE_EXTRACTOR_MODEL_DROPDOWN = gradio.Dropdown(
		...
		choices = faceswap_colab.choices.voice_extractor_models,
