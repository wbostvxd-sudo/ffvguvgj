...
def render() -> None:
	...
	EXPRESSION_RESTORER_MODEL_DROPDOWN = gradio.Dropdown(
		label = translator.get('uis.model_dropdown', 'faceswap_colab.processors.modules.expression_restorer'),
	...
	EXPRESSION_RESTORER_FACTOR_SLIDER = gradio.Slider(
		label = translator.get('uis.factor_slider', 'faceswap_colab.processors.modules.expression_restorer'),
	...
	EXPRESSION_RESTORER_AREAS_CHECKBOX_GROUP = gradio.CheckboxGroup(
		label = translator.get('uis.areas_checkbox_group', 'faceswap_colab.processors.modules.expression_restorer'),
