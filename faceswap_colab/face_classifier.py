...
from faceswap_colab import inference_manager
...
from faceswap_colab.types import Age, DownloadScope, FaceLandmark5, Gender, InferencePool, ModelOptions, ModelSet, Race, VisionFrame
