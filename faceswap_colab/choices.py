...
download_provider_set : DownloadProviderSet =\
{
	'github':
	{
		...
		'path': '/faceswap_colab/faceswap_colab-assets/releases/download/{base_name}/{file_name}'
	},
	'huggingface':
	{
		'urls':
		...
		'path': '/faceswap_colab/{base_name}/resolve/main/{file_name}'
	}
}
