...
from faceswap_colab.common_helper import create_int_metavar
from faceswap_colab.download import conditional_download_hashes, conditional_download_sources, resolve_download_url
from faceswap_colab.face_analyser import scale_face
from faceswap_colab.face_helper import paste_back, warp_face_by_face_landmark_5
from faceswap_colab.face_masker import create_box_mask, create_occlusion_mask
from faceswap_colab.face_selector import select_faces
from faceswap_colab.filesystem import in_directory, is_image, is_video, resolve_relative_path, same_file_extension
from faceswap_colab.processors.live_portrait import create_rotation, limit_expression
from faceswap_colab.processors.modules.expression_restorer import choices as expression_restorer_choices
from faceswap_colab.processors.modules.expression_restorer.types import ExpressionRestorerInputs
from faceswap_colab.processors.types import LivePortraitExpression, LivePortraitFeatureVolume, LivePortraitMotionPoints, LivePortraitPitch, LivePortraitRoll, LivePortraitScale, LivePortraitTranslation, LivePortraitYaw, ProcessorOutputs
from faceswap_colab.program_helper import find_argument_group
from faceswap_colab.thread_helper import conditional_thread_semaphore, thread_semaphore
from faceswap_colab.types import ApplyStateItem, Args, DownloadScope, Face, InferencePool, ModelOptions, ModelSet, ProcessMode, VisionFrame
from faceswap_colab.vision import read_static_image, read_static_video_frame
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		faceswap_colab.jobs.job_store.register_step_keys([ 'expression_restorer_model', 'expression_restorer_factor', 'expression_restorer_areas' ])
