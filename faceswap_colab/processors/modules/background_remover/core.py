...
from faceswap_colab import config, content_analyser, inference_manager, logger, state_manager, translator, video_manager
from faceswap_colab.common_helper import is_macos
...
from faceswap_colab.normalizer import normalize_color
from faceswap_colab.processors.modules.background_remover import choices as background_remover_choices
from faceswap_colab.processors.modules.background_remover.types import BackgroundRemoverInputs
...
from faceswap_colab.types import ApplyStateItem, Args, DownloadScope, ExecutionProvider, InferencePool, Mask, ModelOptions, ModelSet, ProcessMode, VisionFrame
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		faceswap_colab.jobs.job_store.register_step_keys([ 'background_remover_model', 'background_remover_color' ])
