...
from faceswap_colab import config, content_analyser, face_classifier, face_detector, face_landmarker, face_masker, face_recognizer, logger, state_manager, translator, video_manager
from faceswap_colab.face_analyser import scale_face
from faceswap_colab.face_helper import warp_face_by_face_landmark_5
...
from faceswap_colab.filesystem import in_directory, is_image, is_video, same_file_extension
from faceswap_colab.processors.modules.face_debugger import choices as face_debugger_choices
from faceswap_colab.processors.modules.face_debugger.types import FaceDebuggerInputs
...
from faceswap_colab.types import ApplyStateItem, Args, Face, InferencePool, ProcessMode, VisionFrame
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		faceswap_colab.jobs.job_store.register_step_keys([ 'face_debugger_items' ])
